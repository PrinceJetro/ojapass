"""
Django settings for ajopass project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main.context_processors.oja_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'ajopass.wsgi.application'
...
DATABASES = {
     'default': {
         ...
         "PORT" : "6543",
         'USER' : "postgres.rqnmvhmhebkwahnvyfuu",
